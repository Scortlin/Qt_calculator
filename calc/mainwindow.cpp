    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->pushButton_proizv,SIGNAL(clicked()),this,SLOT(math_operations()));

    ui->pushButton_del->setCheckable(true);
    ui->pushButton_minus->setCheckable(true);
    ui->pushButton_plus->setCheckable(true);
    ui->pushButton_proizv->setCheckable(true);
}
...
ui->pushButton_proizv->setChecked(false);
...
void MainWindow::on_pushButton_ravno_clicked()
{
    ...
    if(ui->pushButton_plus->isChecked()){
        ...
        ui->pushButton_del->setChecked(false);
    }else if(ui->pushButton_proizv->isChecked()){
        labelNumber = num_first*num_second;
        new_label = QString::number(labelNumber, 'g',15);
        ui->result_show->setText(new_label);
        ui->pushButton_proizv->setChecked(false);
